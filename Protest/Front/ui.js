...
const UI = {
	...
	SetBackground: (hsl)=> {
		...
		case 44: //yellow
			bg2 = "light-dark(rgb(68,70,211), rgb(62,81,97))";
			break;

		case 96: //green
			bg2 = "light-dark(rgb(126, 68, 211), rgb(62,81,97))";
			break;

		case 200: //blue
			bg2 = "light-dark(rgb(211,182,68), rgb(62,81,97))";
			break;

		default: //orange
			bg2 = "light-dark(rgb(68,148,211), rgb(62,81,97))";
			break;
		}
